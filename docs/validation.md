...
| Full-content mode | Exact source JSON values and types retained, including synthetic sensitive values and raw strings; key collisions, numeric identities, Markdown fencing, no input mutation, and actual SDK private-body serialization |
